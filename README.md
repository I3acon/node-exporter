...
```
wget -O install_exporters.sh https://raw.githubusercontent.com/I3acon/node-exporter/main/install_node_exporter.sh && chmod +x install_node_exporter.sh && ./install_node_exporter.sh
```
